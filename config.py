...
# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Africa:alpha3720@nakflixsharingbot.gvfnufs.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "nakflixsharingbot")
